...
// 40 DEX is minted per block
// 20 DEX per block is sent to Burn pool (A farm just for burning cake)
// 10 DEX per block goes to DEX syrup pool
// 9 DEX per block goes to Yield farms and lottery
// CAKE_PER_BLOCK in config/index.ts = 40 as we only change the amount sent to the burn pool which is effectively a farm.
// DEX/Block in src/views/Home/components/CakeDataRow.tsx = 15 (40 - Amount sent to burn pool)
...
export const BASE_URL = 'https://dextop.pro'
