  ...
  return (
    <>
      ...
      >
        ...
        >
          <BunnyWrapper>
            <Image src={bunnyImage} priority placeholder="blur" alt={t('Lunar bunny')} style={{ borderRadius: '25px', boxShadow: '0 0 8px rgba(0, 0, 0, 1)' }} />
            <Image src={bunnyChart} priority placeholder="blur" alt={t('Lunar bunny')} />
          </BunnyWrapper>
        </Flex>
