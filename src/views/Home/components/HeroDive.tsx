      ...
      >
        <Flex flex="1" flexDirection="column" style={{ paddingLeft: '10px' }}>
          ...
          <Heading scale="df" color="#fff" mb="24px" style={{ lineHeight: '30px' }}>
            {t("Our liquidity pools are live - we are excited to present X-Yield, stake LP tokens to earn great APR! X-Yield also supports the zap function so you can add liquidity easily.")}
          </Heading>
          ...
          <ul style={{ lineHeight: '30px', color: "white", fontSize: "20px" }}>
            ...
            <li>{t('Fort Knox Secure: Our contracts pass rigorous audits, safeguarding every penny you trust us with')}</li>
