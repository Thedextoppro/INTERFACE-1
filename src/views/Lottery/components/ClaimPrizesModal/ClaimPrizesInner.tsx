    ...
    if (receipt?.status) {
      toastSuccess(
        ...
        <ToastDescriptionWithTx txHash={receipt.transactionHash}>
          {t('Your DEX prizes for round %lotteryId% have been sent to your wallet', { lotteryId })}
  ...
  const handleBurn = async () => {
    ...
    if (receipt?.status) {
      toastSuccess(
        t('You have burnt'),
        <ToastDescriptionWithTx txHash={receipt.transactionHash}>
          {t('Your DEX prizes for round %lotteryId% have been burnt to DEAD address', { lotteryId })}
        </ToastDescriptionWithTx>,
      )
      handleProgressToNextClaim()
    }
