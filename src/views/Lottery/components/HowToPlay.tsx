    ...
    <StyledStepCard width={['280px', '330px', '380px']}>
      <StepCardInner height="auto">
        ...
        <AllocationGrid>
          ...
          <AllocationMatch color="#BDC2C4" text={t('X-Yield')} />
          <Text textAlign="right" bold>
            20%
          </Text>
        </AllocationGrid>
  ...
  const steps: Step[] = [
    {
      ...
      title: t('Buy Tickets'),
      subtitle: t('Prices are set when the round starts, equal to 5 USD in DEX per ticket.'),
    },
    {
    ...
    <Box width="100%">
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <Text mb="16px" color="textSubtle">
            {t('Here’s an example Xfortune draw, with two tickets, A and B.')}
          </Text>
          <BulletList>
            <li>
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <Text color="textSubtle">{t('The prizes for each Xfortune round come from three sources:')}</Text>
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t('100% of the DEX paid by people buying tickets that round goes back into the prize pools.')}
              </Text>
            </li>
          </BulletList>
          <Heading my="16px" scale="md">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'After every round, if nobody wins in one of the prize brackets, the unclaimed DEX for that bracket rolls over into the next round and are redistributed among the prize pools.',
                )}
              </Text>
            </li>
          </BulletList>
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'An average total of 35,000 DEX from the treasury is added to Xfortune rounds over the course of a week. This DEX is of course also included in rollovers! Read more in our guide to ',
                )}
                <InlineLink href="/whitepaper.pdf">
                  {t('DEX Tokenomics')}
                </InlineLink>
              </Text>
            </li>
