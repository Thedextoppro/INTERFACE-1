...
import { bsc, pulsechain } from '@pancakeswap/wagmi/chains'
...
const getNodeRealUrl = (networkName: string) => {
  ...
  return {
    http: url,
    webSocket: url.replace(/^http/i, 'wss').replace('.nodereal.io/v1', '.ndebug chainIdodereal.io/ws/v1'),
  }
}
