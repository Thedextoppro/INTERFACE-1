...
export const darkColors = {
  ...
  textSubtle: '#B8ADD2',
  disabled: '#524B63',
  gradientBubblegum: 'linear-gradient(0deg, #1B4175 0%, #4A70A5 100%)',
  gradientInverseBubblegum: 'linear-gradient(139.73deg, #3D2A54 0%, #313D5C 100%)',
  gradientCardHeader: 'linear-gradient(0deg, #1B4175 0%, #4A70A5 100%)',
  ...
  gradients: {
    ...
    cardHeader: "linear-gradient(0deg, #1B4175 0%, #4A70A5 100%)",
